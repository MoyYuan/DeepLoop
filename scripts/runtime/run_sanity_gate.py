...
from deeploop.research.sanity_gates import DEFAULT_CONTRACT_PATH, evaluate_research_sanity
...
def main() -> int:
    ...
    result = evaluate_research_sanity(
    ...
    print(f"sanity-gate: verdict {result['verdict']}")
    print(f"sanity-gate: wrote {result['report_json_path']}")
    print(f"sanity-gate: wrote {result['report_markdown_path']}")
