    ...
    *,
    ...
    lines.extend(
        [
            ...
            "## Required output",
            "",
            "Return the JSON object only. Do not explain it, do not wrap it in markdown, and do not describe file-writing limits.",
            f"DeepLoop will write the returned JSON to `{result_json_path}`.",
